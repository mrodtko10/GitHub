...
Sub RefreshHTMLDashboard()
    ...
    For i = 4 To lastRow
        ...
        Dim suPo  As Double, ocPo  As Double, maPo  As Double
        ...
        Dim suAdj As Double, ocAdj As Double, maAdj As Double
        ...
        suPo  = N(wsData.Cells(i,18)): ocPo  = N(wsData.Cells(i,19)): maPo  = N(wsData.Cells(i,20))
        ...
        suAdj = N(wsData.Cells(i,36)): ocAdj = N(wsData.Cells(i,37)): maAdj = N(wsData.Cells(i,38))
        suRem = N(wsData.Cells(i,39)): ocRem = N(wsData.Cells(i,40)): maRem = N(wsData.Cells(i,41))

        ' ou_status derived from remaining EAC total
        Dim ouStatus As String
        Dim tRem As Double
        tRem = suRem + ocRem + maRem
        If (suEac + ocEac + maEac) = 0 And tRem = 0 Then
            ouStatus = "N/A"
        ElseIf tRem < 0 Then
            ouStatus = "Over"
        Else
        ...
        rec = "{" & _
            ...
            Q("su_po")  & ":" & J(suPo)  & "," & Q("oc_po")  & ":" & J(ocPo)  & "," & Q("ma_po")  & ":" & J(maPo)  & "," & _
            ...
            Q("su_adj") & ":" & J(suAdj) & "," & Q("oc_adj") & ":" & J(ocAdj) & "," & Q("ma_adj") & ":" & J(maAdj) & "," & _
